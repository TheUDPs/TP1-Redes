...
def test_01_server_can_handle_correctly_3_downloads_and_3_uploads_simultaneously(
    ...
    filepath_for_upload = f"{tmp_dirpath}/test_file_upload1.txt"
    filepath_for_download = f"{tmp_dirpath}/server/test_file_download.txt"
    generate_random_text_file(filepath_for_upload, 1)
    generate_random_text_file(filepath_for_download, 1)
