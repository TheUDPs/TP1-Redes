...
Se encontraron dificultades para armar el plugin dinámico que reconozca el protocolo que se esta utilizando y a partir de allí realizar el formateo del contenido del paquete, con lo cual, se adquirieron los conocimientos básicos del uso del lenguaje de programación Lua y también de la integración de dicho lenguaje con la herramienta Wireshark.
