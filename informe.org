...
Si bien se detallaron ejemplos manuales donde se probaron las características del protocolo de aplicación desarrollado, también de desarrollaron pruebas automatizadas con /pytest/, siendo ventajoso el hecho de que Mininet está desarrollo en Python y ofrece una API.
...
- Caso download cuando el archivo a subir ya existe con el nombre proveido en el servidor.
...
En términos de avance del proyecto, primero desarrollamos el procolo SAW, por lo que para el comienzo del desarrollo de el protocolo GBN ya teníamos el conocimiento de ejecución y el código ya armado para el SAW.
